...
public class AppMain {
    ...
    private static JSONObject generateNotification() {
        ...
        // 客户端弹时间
        appNotification.setAp_time((currentTimeMillis() - rand.nextInt(99999999)) + "");
    ...
    private static JSONObject packEventJson(String eventName, JSONObject jsonObject) {
        ...
        eventJson.put("ett", (currentTimeMillis() - rand.nextInt(99999999)) + "");
    ...
    private static JSONObject generateFavorites() {
        ...
        favorites.setAdd_time((currentTimeMillis() - rand.nextInt(99999999)) + "");
    ...
    private static JSONObject generatePraise() {
        ...
        praise.setAdd_time((currentTimeMillis() - rand.nextInt(99999999)) + "");
    ...
    private static JSONObject generateComment() {
        ...
        comment.setAddtime((currentTimeMillis() - rand.nextInt(99999999)) + "");
